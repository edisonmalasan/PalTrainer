...
Placeholder — existing capability retains its purpose (empty, loading, and guidance states). This delta extends state coverage to the shell v3 surfaces and fixes known state bugs.

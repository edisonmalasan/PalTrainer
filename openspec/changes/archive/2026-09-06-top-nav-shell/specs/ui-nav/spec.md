...
**Migration**: Navigation IDs (`tools` … `docs`), signal contracts, and lazy page construction are preserved verbatim; the same destinations are now grouped in the top nav strip per the "Nav strip groups all 12 destinations" requirement.

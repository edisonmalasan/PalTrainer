...
HEADER_SECTION = '<div align="center">\n\n![PalTrainer Logo](../assets/branding/PalTrainer_Blue.png)\n\n# PalTrainer\n\n**{title}**\n\n[![Downloads](https://img.shields.io/github/downloads/edisonmalasan/PalTrainer/total)](https://github.com/edisonmalasan/PalTrainer/releases/latest)\n[![License](https://img.shields.io/github/license/edisonmalasan/PalTrainer)](LICENSE)\n[![Discord](https://img.shields.io/badge/Discord-Join_for_support-blue)](https://discord.gg/sYcZwcT4cT)\n[![community releases](https://img.shields.io/badge/community releases-Download-orange)](https://github.com/edisonmalasan/PalTrainer/releases)\n\n[English](../../README.md) | [简体中文](README.zh_CN.md) | [Deutsch](README.de_DE.md) | [Español](README.es_ES.md) | [Français](README.fr_FR.md) | [Русский](README.ru_RU.md) | [日本語](README.ja_JP.md) | [한국어](README.ko_KR.md) | [Português (Brasil)](README.pt_BR.md) | [Português (Portugal)](README.pt_PT.md)\n\n---\n\n### **{download_text} [GitHub Releases](https://github.com/edisonmalasan/PalTrainer/releases/latest)** {download_link}\n\n---\n\n</div>\n'
...
def protect_platform_terms(text: str, pm: PlaceholderManager) -> str:
    platform_terms = ['Discord', 'GitHub', 'Steam', 'GamePass', 'community releases', 'Wiki', 'uv']
    protected_text = text
...
def protect_game_terms(text: str, pm: PlaceholderManager) -> str:
    game_terms = ['Pal Editor', '\\bpals?\\b', '\\bPal\\b', '\\bIVs\\b', '\\bIV\\b', 'passives', 'private chests', 'PalTrainer']

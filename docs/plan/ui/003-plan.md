> **RESET 2026-09-04: INFRASTRUCTURE RETAINED — VISUALS RE-DERIVED.** Shared
> components, confirm system, safe dialog helpers, and table behavior from this
> plan remain available infrastructure. Their visual treatment is re-derived by
> plans 020–023 against the new shell and palette. Do not cite this plan for
> component composition of specific screens.

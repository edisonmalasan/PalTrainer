...
export function DiagnosticsView() {
  ...
  return (
    <ViewShell
      title="Save Diagnostics & Integrity"
      subtitle="Comprehensive structural validation, anomaly detection, and maintenance reporting across the loaded save."
      status={state.status}
                      ...
                      >
                        <div className="flex flex-wrap items-center justify-between gap-2">
                          ...
                          <span className="font-mono text-[11px] text-shell-muted">
                            Target: <span className="font-semibold text-shell-ink">{issue.targetId}</span>
                          </span>
                        </div>
                        ...
                        {issue.canAutoRepair && issue.repairAction && (
                          <div className="mt-1 flex items-center gap-2 font-mono text-[11px] text-emerald-500">
                            ...
                            <span>
                              Repairable: {issue.repairAction.label} ({issue.repairAction.affectedEntityCount} entities)
                            </span>
                          </div>
                        )}
                      </div>

...
TEXT_MUTED = MUTED
SURFACE_ELEVATED = '#211E1B'
SURFACE_HOVER = 'rgba(245,158,11,0.07)'
BORDER_SUBTLE = 'rgba(245,158,11,0.15)'
ACCENT_BG = 'rgba(245,158,11,0.10)'
ACCENT_BG_STRONG = 'rgba(245,158,11,0.18)'
ACCENT_BORDER = 'rgba(245,158,11,0.20)'
ACCENT_BORDER_HOVER = 'rgba(245,158,11,0.35)'
ACCENT_BORDER_FOCUS = 'rgba(245,158,11,0.40)'
INFO = '#93B7DD'
SPECIAL = '#C084FC'
RARITY_1 = '#9CA3AF'
RARITY_2 = '#4ADE80'

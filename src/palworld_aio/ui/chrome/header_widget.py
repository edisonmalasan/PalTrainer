...
class HeaderWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.info_btn.setToolTip(t('about.title') if t else 'About PalTrainer')
        self.info_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self.warn_btn.setFixedSize(32, 32)
        ...
        self.warn_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self.toolbox_btn.setFixedSize(32, 32)
        ...
        self.toolbox_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self.save_btn.setAccessibleName(t('menu.file.save_changes') if t else 'Save Changes')
        self.save_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self._loading_btn.setFixedSize(32, 32)
        self._loading_btn.setStyleSheet(btn_style)
        self._loading_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        self._loading_btn.setVisible(False)
        ...
        self.minimize_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self.maximize_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
        ...
        self.close_btn.setFont(QFont(constants.FONT_FAMILY_NERD, 14))
    ...
    def _open_stable(self):
        import webbrowser
        webbrowser.open('https://github.com/edisonmalasan/PalTrainer/releases/latest')
    ...
    def update_logo(self):
        ...
        logo_candidates = ['logo.png', 'PalTrainer_Blue.png', 'PalTrainer.png']
        pixmap = None
        ...
        if pixmap is not None:
            ...
            self.logo_label.setText('PALTRAINER')
    ...
    def set_dirty(self, dirty):
        """Emphasize the save action while unsaved changes exist."""
        if not hasattr(self, 'save_btn'):
            return
        if self.save_btn.property('dirty') == dirty:
            return

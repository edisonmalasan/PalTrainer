...
class MapGraphicsView(QGraphicsView):
    marker_clicked = pyqtSignal(object, object)
    marker_double_clicked = pyqtSignal(object, object)
    marker_right_clicked = pyqtSignal(object, QPointF)
    empty_space_right_clicked = pyqtSignal(QPointF)
    marker_hover_entered = pyqtSignal(object, QPointF)
    marker_hover_left = pyqtSignal()
    zone_right_clicked = pyqtSignal(object, QPointF)
    zone_double_clicked = pyqtSignal(object)
    zone_point_a_set = pyqtSignal(QPointF)
    zone_created = pyqtSignal(QPointF, QPointF)
    zone_drawing_cancelled = pyqtSignal()
    polygon_point_added = pyqtSignal(QPointF)
    polygon_closed = pyqtSignal(list)
    zoom_changed = pyqtSignal(float)
    calibration_clicked = pyqtSignal(float, float)

import os
import re
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QLineEdit, QListWidget, QListWidgetItem, QStyledItemDelegate, QApplication
from PyQt6.QtCore import Qt, QTimer, QRectF, QSize, QPoint, QThread
from PyQt6.QtGui import QPainter, QColor, QPen, QBrush, QLinearGradient, QIcon, QCursor, QFontMetrics

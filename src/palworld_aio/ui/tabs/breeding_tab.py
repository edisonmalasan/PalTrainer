...
import os
import re
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QScrollArea, QFrame, QDialog, QLineEdit, QListWidgetItem
...
class BreedingTab(QWidget):
    ...
    def _render_cards(self, pal_info_map):
        ...
        prev_btn.setIcon(app_icons.get_qicon('chevron_left', role='text_secondary'))
        ...
        next_btn.setIcon(app_icons.get_qicon('chevron_right', role='text_secondary'))
    ...
    def _make_pair_card(self, parent_a, parent_b, child, pal_info_map):
        ...
        sep1 = QLabel(PLUS)
        sep1.setFont(QFont(constants.FONT_FAMILY, 16))
        ...
        sep2.setFont(QFont(constants.FONT_FAMILY, 16))

...
class InventoryGridWidget(QWidget):
    item_added = pyqtSignal(int, str, int)
    item_removed = pyqtSignal(int, int)
    item_count_changed = pyqtSignal(int, int)
    item_context_menu = pyqtSignal(dict, QPoint)
    empty_slot_context_menu = pyqtSignal(str, int, QPoint)
    item_double_clicked = pyqtSignal(dict)
    empty_slot_double_clicked = pyqtSignal(str, int)
    item_selected = pyqtSignal(dict)
    multi_delete_requested = pyqtSignal(list)
    multi_clear_qty_requested = pyqtSignal(list)
    add_all_effigies_requested = pyqtSignal()
    add_all_key_items_requested = pyqtSignal()
    clear_key_items_requested = pyqtSignal()
...
class PlayerInventoryTab(QWidget):
    unlock_all_map_requested = pyqtSignal(list)
    saved = pyqtSignal()
    def __init__(self, parent=None):
        super().__init__(parent)

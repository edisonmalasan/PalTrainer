...
class PartySlotWidget(QFrame):
    ...
    slotDropped = pyqtSignal(int, int)
    ...
    def resizeEvent(self, event):
        ...
        if self._lvl_overlay and not sip.isdeleted(self._lvl_overlay) and (not self._lvl_overlay.isHidden()):
        ...
        if hasattr(self, '_badges') and self._badges:
            ...
            for badge in self._badges:
                ...
                if not sip.isdeleted(badge) and (not badge.isHidden()):

...
class PalInfoWidget(PalInfoDisplayMixin, PalInfoHandlerMixin, QFrame):
    ...
    def _clear_display(self):
        ...
        for s in self.passive_slots:
            s.setText('--')
            s.setStyleSheet('font-size: 11px; font-weight: 700; color: rgba(255,255,255,0.3); background: transparent; border: none;')
    ...
    def _build_header(self, parent):
        ...
        lv_label.setStyleSheet('font-size: 11px; font-weight: 600; color: #7DD3FC; letter-spacing: 2px; background: transparent; border: none;')
        ...
        next_label.setStyleSheet('font-size: 11px; font-weight: 600; color: #9CA3AF; background: transparent; border: none;')
        next_row.addWidget(next_label)
        self.next_lbl = QLabel('0')
        self.next_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #E2E8F0; background: transparent; border: none;')
        ...
        if awake_icon:
            ...
            self.info_awake_btn.setText('ðŸ”¥')
    ...
    def _build_body(self, parent):
        ...
        self.predator_overlay.setText(nf.icons.get('nf-fa-paw', 'ðŸ¾'))
        ...
        self.trust_bar.setStyleSheet('QProgressBar { background: rgba(30,20,25,0.6); border: 1px solid rgba(244,114,182,0.20); border-radius: 2px; text-align: center; font-size: 11px; font-weight: 700; color: #FFFFFF; } QProgressBar::chunk { background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 #EC4899,stop:1 #F472B6); border-radius: 2px; }')
        ...
        hp_icon.setStyleSheet('font-size: 11px; color: #EF4444; background: transparent; border: none;')
        ...
        self.hp_bar.setStyleSheet('QProgressBar { background: rgba(20,40,30,0.6); border: 1px solid rgba(16,185,129,0.2); border-radius: 2px; text-align: center; font-size: 11px; font-weight: 700; color: #FFFFFF; } QProgressBar::chunk { background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 #10B981,stop:1 #34D399); border-radius: 2px; }')
        hp_row.addWidget(self.hp_bar, 1)
        right_layout.addLayout(hp_row, 1)
        hunger_row = QHBoxLayout()
        hunger_row.setSpacing(0)
        hunger_icon = QLabel('âš¬')
        hunger_icon.setFixedSize(14, 14)
        hunger_icon.setAlignment(Qt.AlignCenter)
        hunger_icon.setStyleSheet('font-size: 11px; color: #F59E0B; background: transparent; border: none;')
        ...
        self.hunger_bar.setStyleSheet('QProgressBar { background: rgba(40,30,20,0.6); border: 1px solid rgba(245,158,11,0.2); border-radius: 2px; text-align: center; font-size: 11px; font-weight: 700; color: #FFFFFF; } QProgressBar::chunk { background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 #F59E0B,stop:1 #FBBF24); border-radius: 2px; }')
        ...
        san_icon.setStyleSheet('font-size: 11px; color: #10B981; background: transparent; border: none;')
        ...
        self.san_bar.setStyleSheet('QProgressBar { background: rgba(20,30,40,0.6); border: 1px solid rgba(56,189,248,0.2); border-radius: 2px; text-align: center; font-size: 11px; font-weight: 700; color: #FFFFFF; } QProgressBar::chunk { background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 #38BDF8,stop:1 #7DD3FC); border-radius: 2px; }')
    ...
    def _build_skills(self, parent):
        ...
        self._c_icon.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); }')
        ...
        self.partner_desc_lbl.setStyleSheet('font-size: 11px; color: #9CA3AF; background: transparent; border: none; padding: 0 2px;')
        ...
        self._as_prev_btn.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); } QPushButton:disabled { color: rgba(255,255,255,0.15); background: transparent; border-color: rgba(255,255,255,0.05); }')
        ...
        self._as_page_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #94A3B8; background: transparent; border: none;')
        as_header.addWidget(self._as_page_lbl)
        self._as_next_btn = QPushButton('>')
        self._as_next_btn.setFixedSize(16, 14)
        self._as_next_btn.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); } QPushButton:disabled { color: rgba(255,255,255,0.15); background: transparent; border-color: rgba(255,255,255,0.05); }')
        ...
        self._as_c_icon.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); }')
        ...
        self._ps_prev_btn.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); } QPushButton:disabled { color: rgba(255,255,255,0.15); background: transparent; border-color: rgba(255,255,255,0.05); }')
        ...
        self._ps_page_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #94A3B8; background: transparent; border: none;')
        passive_header.addWidget(self._ps_page_lbl)
        self._ps_next_btn = QPushButton('>')
        self._ps_next_btn.setFixedSize(16, 14)
        self._ps_next_btn.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); } QPushButton:disabled { color: rgba(255,255,255,0.15); background: transparent; border-color: rgba(255,255,255,0.05); }')
        ...
        self._l_icon.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #7DD3FC; background: rgba(125,211,252,0.08); border: 1px solid rgba(125,211,252,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(125,211,252,0.15); }')

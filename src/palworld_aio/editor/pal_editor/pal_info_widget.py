...
class PalInfoWidget(PalInfoDisplayMixin, PalInfoHandlerMixin, QFrame):
    ...
    def _clear_display(self):
        ...
        for s in self.passive_slots:
            s.setText('--')
            s.setStyleSheet(f'font-size: 11px; font-weight: 700; color: {_P["text_disabled"]}; background: transparent; border: none;')
            parent_frame = s.parentWidget()
            if parent_frame and parent_frame.objectName() == 'passiveCard':
                parent_frame.setStyleSheet(f'QFrame#passiveCard {{ background: {_P["surface_raised"]}; border: 1px solid {_P["border"]}; border-radius: 4px; }}')
    ...
    def _build(self):
        ...
        inner.setStyleSheet(f'QWidget#palInfoInner {{ background: {_P["surface"]}; border: 1px solid {_P["border_strong"]}; border-radius: 6px; }}')
        ...
        self._no_data_overlay.setStyleSheet(f'font-size: 16px; font-weight: 700; color: {_P["text_disabled"]}; background: {_P["surface"]}; border: 1px solid {_P["border_strong"]}; border-radius: 6px;')
        self._no_data_overlay.show()
        scroll.hide()
        ...
        self._stat_tip.setStyleSheet(f'background: {_P["tooltip_bg"]}; color: {_P["text"]}; border: 1px solid {_P["info_border"]}; border-radius: 6px; padding: 6px 10px; font-size: 11px;')
    ...
    def _build_header(self, parent):
        ...
        level_box = CornerBracketWidget(_P['info'])
        ...
        lv_label.setStyleSheet(f'font-size: 11px; font-weight: 600; color: {_P["info"]}; letter-spacing: 2px; background: transparent; border: none;')
        ...
        next_label.setStyleSheet(f'font-size: 11px; font-weight: 600; color: {_P["text_secondary"]}; background: transparent; border: none;')
        ...
        if gender_def:
            self.gender_icon.setIcon(QIcon(gender_def))
        self.gender_icon.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:checked {{ background: {_P["special_bg"]}; border: 1px solid {_P["special"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }}')
        ...
        # modernize-tab-ui 4.1: retired Nerd Font glyphs -> bundled SVG icons
        # with clean text fallbacks; FONT_FAMILY_NERD setFont calls removed.
        self.info_predator_btn = QPushButton()
        paw_pix = app_icons.get_pixmap('paw', role='text_secondary', size=12)
        if paw_pix:
            self.info_predator_btn.setIcon(QIcon(paw_pix))
        else:
            self.info_predator_btn.setText('P')
        self.info_predator_btn.setCheckable(True)
        self.info_predator_btn.setFixedSize(18, 18)
        self.info_predator_btn.setIconSize(QSize(12, 12))
        self.info_predator_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; font-size: 9px; font-weight: 700; }} QPushButton:checked {{ background: {_P["danger_bg"]}; border: 1px solid {_P["danger"]}; color: {_P["danger"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }} QPushButton:disabled {{ background: transparent; border: 1px solid rgba(255,255,255,0.03); color: {_P["text_disabled"]}; }}')
        ...
        self.info_lucky_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:checked {{ background: {_P["special_bg"]}; border: 1px solid {_P["special"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }} QPushButton:disabled {{ background: transparent; border: 1px solid rgba(255,255,255,0.03); }}')
        ...
        if awake_icon:
            ...
            self.info_awake_btn.setText('Aw')
        self.info_awake_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; font-size: 10px; }} QPushButton:checked {{ background: {_P["warning_bg"]}; border: 1px solid {_P["warning"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }}')
        ...
        self.info_cheat_btn = QPushButton('C')
        self.info_cheat_btn.setCheckable(True)
        self.info_cheat_btn.setFixedSize(18, 18)
        self.info_cheat_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; font-size: 9px; font-weight: 700; }} QPushButton:checked {{ background: {_P["danger_bg"]}; border: 1px solid {_P["danger"]}; color: {_P["danger"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }}')
        ...
        self.info_max_btn = QPushButton('M')
        self.info_max_btn.setFixedSize(18, 18)
        self.info_max_btn.setStyleSheet(f'QPushButton {{ font-size: 9px; font-weight: 700; padding: 0px; margin: 0px; background: transparent; color: {_P["success"]}; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:hover {{ background: rgba(74,222,128,0.15); color: #FFFFFF; }}')
        ...
        self.info_max_buff_btn = QPushButton('F')
        self.info_max_buff_btn.setFixedSize(18, 18)
        self.info_max_buff_btn.setStyleSheet(f'QPushButton {{ font-size: 9px; font-weight: 700; padding: 0px; margin: 0px; background: transparent; color: {_P["warning"]}; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:hover {{ background: rgba(249,115,22,0.15); color: #FFFFFF; }}')
        ...
        self.info_dna_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:checked {{ background: {_P["info_bg"]}; border: 1px solid {_P["info"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }}')
        ...
        self.info_fav_btn.setStyleSheet(f'QPushButton {{ background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; }} QPushButton:checked {{ background: {_P["warning_bg"]}; border: 1px solid {_P["warning"]}; }} QPushButton:hover {{ background: rgba(255,255,255,0.08); }}')
        ...
        # modernize-tab-ui 4.4: raw GUID demoted to tooltip; the button shows a
        # compact ID affordance and keeps its click-to-copy behavior.
        self.instance_id_lbl = QPushButton('ID')
        self.instance_id_lbl._instance_id = ''
        self.instance_id_lbl.setFlat(True)
        self.instance_id_lbl.setStyleSheet(f'QPushButton {{ font-size: 9px; font-weight: 700; color: {_P["text_disabled"]}; background: transparent; border: none; text-align: left; padding: 0; }} QPushButton:hover {{ color: {_P["info"]}; }}')
        ...
        self.exp_header_bar.setObjectName('palStatBar')
        self.exp_header_bar.setProperty('barTier', 'special')
    ...
    def _build_body(self, parent):
        ...
        portrait_frame.setStyleSheet(f'QFrame#portraitGlow {{ background: qradialgradient(cx:0.5,cy:0.5,radius:0.6,fx:0.5,fy:0.5,stop:0 {_P["info_bg"]},stop:0.4 {_P["info_bg"]},stop:1 transparent); border: none; border-radius: 44px; }}')
        ...
        self.lock_overlay.setStyleSheet('font-size: 11px; color: rgba(255,255,255,0.65); background: rgba(0,0,0,0.55); border: 1px solid rgba(255,255,255,0.12); border-radius: 7px;')
        ...
        self.predator_overlay.setStyleSheet(f'background: transparent; border: none; font-size: 10px; font-weight: bold; color: {_P["danger"]};')
        self.predator_overlay.setText('P')
        ...
        self.stat_plus_lbl.setStyleSheet(f'font-size: 11px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        ...
        self.iv_icon.setStyleSheet('QPushButton { background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; } QPushButton:hover { background: rgba(255,255,255,0.08); }')
        ...
        self.ivs_hp_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.ivs_atk_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.ivs_def_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.soul_row_icon.setStyleSheet('QPushButton { background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; } QPushButton:hover { background: rgba(255,255,255,0.08); }')
        ...
        self.soul_hp_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.soul_atk_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.soul_def_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.soul_craft_lbl.setStyleSheet('font-size: 11px; font-weight: 600; color: #FFFFFF; background: transparent; border: none; padding: 1px 0px;')
        ...
        self.trust_bar.setObjectName('palStatBar')
        self.trust_bar.setProperty('barTier', 'special')
        trust_row.addWidget(self.trust_bar, 1)
        right_layout.addLayout(trust_row, 1)
        hp_row = QHBoxLayout()
        hp_row.setSpacing(0)
        hp_icon = QLabel('HP')
        hp_icon.setFixedSize(20, 14)
        hp_icon.setAlignment(Qt.AlignCenter)
        hp_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["success"]}; background: transparent; border: none;')
        ...
        hunger_icon = QLabel('FD')
        hunger_icon.setFixedSize(20, 14)
        hunger_icon.setAlignment(Qt.AlignCenter)
        hunger_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["warning"]}; background: transparent; border: none;')
        ...
        self.hunger_bar.setObjectName('palStatBar')
        self.hunger_bar.setProperty('barTier', 'warning')
        hunger_row.addWidget(self.hunger_bar, 1)
        right_layout.addLayout(hunger_row, 1)
        san_row = QHBoxLayout()
        san_row.setSpacing(0)
        san_icon = QLabel('SAN')
        san_icon.setFixedSize(24, 14)
        san_icon.setAlignment(Qt.AlignCenter)
        san_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        ...
        self.san_bar.setObjectName('palStatBar')
        self.san_bar.setProperty('barTier', 'info')
        ...
        atk_icon = QLabel('ATK')
        atk_icon.setFixedSize(24, 14)
        atk_icon.setAlignment(Qt.AlignCenter)
        atk_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["danger"]}; background: transparent; border: none;')
        ...
        atk_label.setStyleSheet(f'font-size: 10px; color: {_P["text_secondary"]}; background: transparent; border: none;')
        ...
        def_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        ...
        def_label.setStyleSheet(f'font-size: 10px; color: {_P["text_secondary"]}; background: transparent; border: none;')
        ...
        wspd_icon.setStyleSheet(f'font-size: 8px; font-weight: 700; color: {_P["special"]}; background: transparent; border: none;')
        ...
        wspd_label.setStyleSheet(f'font-size: 10px; color: {_P["text_secondary"]}; background: transparent; border: none;')
        ...
        for idx, ws_key in enumerate(self.NATIVE_WORK_ORDER):
            ...
            wl.setStyleSheet('font-size: 11px; font-weight: 700; color: transparent; background: transparent; border: none;')
    ...
    def _build_skills(self, parent):
        ...
        self.partner_name_lbl.setStyleSheet(f'font-size: 11px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        pheader.addWidget(self.partner_name_lbl)
        pheader.addStretch()
        self._c_icon = QPushButton('[C]')
        self._c_icon.setFixedSize(22, 16)
        self._c_icon.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }}')
        ...
        self.partner_desc_lbl.setStyleSheet(f'font-size: 11px; color: {_P["text_secondary"]}; background: transparent; border: none; padding: 0 2px;')
        ...
        as_title.setStyleSheet(f'font-size: 10px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        as_header.addWidget(as_title)
        self._as_page = 0
        self._as_prev_btn = QPushButton('<')
        self._as_prev_btn.setFixedSize(16, 14)
        self._as_prev_btn.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }} QPushButton:disabled {{ color: {_P["text_disabled"]}; background: transparent; border-color: rgba(255,255,255,0.05); }}')
        ...
        self._as_page_lbl.setStyleSheet(f'font-size: 11px; font-weight: 600; color: {_P["text_secondary"]}; background: transparent; border: none;')
        as_header.addWidget(self._as_page_lbl)
        self._as_next_btn = QPushButton('>')
        self._as_next_btn.setFixedSize(16, 14)
        self._as_next_btn.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }} QPushButton:disabled {{ color: {_P["text_disabled"]}; background: transparent; border-color: rgba(255,255,255,0.05); }}')
        ...
        self._as_c_icon.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }}')
        ...
        passive_title.setStyleSheet(f'font-size: 10px; font-weight: 700; color: {_P["info"]}; background: transparent; border: none;')
        passive_header.addWidget(passive_title)
        self._ps_page = 0
        self._ps_prev_btn = QPushButton('<')
        self._ps_prev_btn.setFixedSize(16, 14)
        self._ps_prev_btn.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }} QPushButton:disabled {{ color: {_P["text_disabled"]}; background: transparent; border-color: rgba(255,255,255,0.05); }}')
        ...
        self._ps_page_lbl.setStyleSheet(f'font-size: 11px; font-weight: 600; color: {_P["text_secondary"]}; background: transparent; border: none;')
        passive_header.addWidget(self._ps_page_lbl)
        self._ps_next_btn = QPushButton('>')
        self._ps_next_btn.setFixedSize(16, 14)
        self._ps_next_btn.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }} QPushButton:disabled {{ color: {_P["text_disabled"]}; background: transparent; border-color: rgba(255,255,255,0.05); }}')
        ...
        self._all_passives_btn.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #F59E0B; background: rgba(245,158,11,0.1); border: 1px solid rgba(245,158,11,0.35); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(245,158,11,0.2); color: #FFFFFF; }')
        ...
        self._l_icon.setStyleSheet(f'QPushButton {{ font-size: 11px; font-weight: 700; color: {_P["info"]}; background: {_P["info_bg"]}; border: 1px solid {_P["info_border"]}; border-radius: 3px; padding: 0px; margin: 0px; }} QPushButton:hover {{ background: {_P["info_border"]}; }}')
        ...
        # modernize-tab-ui 4.3: flat token placeholder for passive chips.
        default_tc = _P['text_secondary']
        default_bg = _P['surface_raised']
        ...
        for i, pname in enumerate(placeholder_names):
            ...
            card.setStyleSheet(f'QFrame#passiveCard {{ background: {default_bg}; border: 1px solid {_P["border"]}; border-radius: 4px; }}')

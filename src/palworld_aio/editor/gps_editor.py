...
from PyQt6.QtWidgets import QDialog, QHBoxLayout, QVBoxLayout, QPushButton, QScrollArea, QGridLayout, QWidget, QLabel, QFileDialog, QFrame, QLineEdit
...
class GpsEditorDialog(FramelessDialog):
    ...
    def _setup_ui(self):
        ...
        self.page_label.setStyleSheet('font-size: 12px; font-weight: 700; color: #F59E0B;')
    ...
    def _on_sort_clicked(self):
        ...
        mode = popup.exec(self.sort_btn.mapToGlobal(self.sort_btn.rect().bottomLeft()))
        if not mode:
            return

...
- **Next task:** 9.2 — Complete change review and affected-count/risk confirmations across remaining bulk workflows. The pending-change menu offers Undo/Redo only for supported callbacks, close Save/Discard/Cancel preserves work on failure or cancellation, and bulk item Add discloses quantity and affected player count before execution.

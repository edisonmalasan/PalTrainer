...
def _is_strict() -> bool:
    return bool(int(os.environ.get("PALTRAINER_STRICT_ICONS", "0")))


def _is_ruthless() -> bool:
    """Return True in 'no mercy' mode (--ruthless / PALTRAINER_RUTHLESS=1).
    ...
    """
    return bool(int(os.environ.get("PALTRAINER_RUTHLESS", "0")))
...
# ===================================================================
# TestIconFileExistence  (WARN default, FAIL with PALTRAINER_STRICT_ICONS=1)
# ===================================================================
...
class TestIconFileExistence:
    ...
    Set PALTRAINER_STRICT_ICONS=1 to make this a hard failure (for CI).
    ...
    def _check_category(category_refs: list, label: str):
        ...
        Only warns/fails in ruthless mode (--ruthless / PALTRAINER_RUTHLESS=1).
...
# ===================================================================
# TestDynamicIconPatterns  (WARN / HARD FAIL based on PALTRAINER_STRICT_ICONS)
# ===================================================================
...
class TestAssetIconCorrelation:
    ...
    def _check_category(entries, label: str):
        ...
        In ruthless mode (PALTRAINER_RUTHLESS=1 / --ruthless), this runs the full
